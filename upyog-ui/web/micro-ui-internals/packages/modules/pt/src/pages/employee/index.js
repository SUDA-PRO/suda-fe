...
const EmployeeApp = ({ path, url, userType }) => {
  ...
  const breadcrumbObj = {
    ["/suda-ui/employee/pt/inbox"]: "ES_TITLE_INBOX",
    ["/suda-ui/employee/pt/new-application"]: "ES_TITLE_NEW_PROPERTY_APPLICATION",
  ...
  const getBreadCrumb = () => {
    ...
    else if (location.pathname.includes("/suda-ui/employee/pt/application-details/")) return t("PT_APPLICATION_TITLE");
    else if (location.pathname.includes("/suda-ui/employee/pt/property-details/")) return t("PT_PROPERTY_INFORMATION");
    else if (location.pathname.includes("/suda-ui/employee/pt/payment-details/")) return t("PT_PAYMENT_HISTORY");
    else if (location.pathname.includes("/suda-ui/employee/pt/assessment-details/")) return t("PT_ASSESS_PROPERTY");
    else if (location.pathname.includes("suda-ui/employee/pt/property-mutate-docs-required")) return t("PT_REQIURED_DOC_TRANSFER_OWNERSHIP");
    else if (location.pathname.includes("/suda-ui/employee/pt/property-mutate/")) return t("ES_TITLE_MUTATE_PROPERTY");
    else if (location.pathname.includes("/suda-ui/employee/pt/modify-application/")) return t("PT_UPDATE_PROPERTY");
  };
  ...
  const PTBreadCrumbs = ({ location }) => {
    ...
    const crumbs = [
      ...
      {
        path: "/suda-ui/employee/pt/inbox",
        content: t("ES_TITLE_INBOX"),
        show: location.pathname.includes("pt/inbox") ? true : false,
      },
      {
        path: "/suda-ui/employee/pt/search",
      ...
      {
        path: `/suda-ui/employee/pt/property-details/${sessionStorage.getItem("propertyIdinPropertyDetail")}?${fromScreen2?`from=${fromScreen2}` : ''}`,
        content: fromScreen || fromScreen2 ? `${t(fromScreen || fromScreen2)} / ${t("PT_PROPERTY_INFORMATION")}`:t("PT_PROPERTY_INFORMATION"),
        show: location.pathname.includes("/pt/property-details/") || location.pathname.includes("/pt/payment-details/") ? true : false,
        isBack:true,
      },
      {
        path: `/suda-ui/employee/pt/applicationsearch/application-details/${sessionStorage.getItem("applicationNoinAppDetails")}`,
      ...
      {
        path: "/suda-ui/employee/pt/payment-details/",
      ...
      {
        path: "/suda-ui/employee/pt/assessment-details/",
      ...
      <React.Fragment>
        <div className="ground-container">
          {/* <p className="breadcrumb" style={{ marginLeft: mobileView ? "2vw" : "revert" }}>
            <Link to="/suda-ui/employee" style={{ cursor: "pointer", color: "#666" }}>
              {t("ES_COMMON_HOME")}
            </Link>{" "}
