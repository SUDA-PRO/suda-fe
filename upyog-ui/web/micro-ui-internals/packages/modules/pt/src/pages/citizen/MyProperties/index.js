...
export const MyProperties = () => {
  ...
  const { isLoading, data } = Digit.Hooks.pt.usePropertySearchNew({ filters: filter1, searchedFrom: "myPropertyCitizen" }, { filters: filter1 });
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto" }}>
        ...
        {count !== 0 && (
          <div style={{ textAlign: "center", marginTop: "28px" }}>
            <Link to={`/suda-ui/citizen/pt/property/my-properties/${t1}`} style={{ textDecoration: "none" }}>
