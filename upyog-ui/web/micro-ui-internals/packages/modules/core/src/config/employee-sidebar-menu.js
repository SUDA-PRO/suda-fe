...
const EmployeeSideBarMenu = (t, HRMS, FSM, PT, mCollect, DSS, RECEIPTS, TL, NOC, FSTPOperator, PGR, ...links) => [
    ...
    links: [
      {
        ...
        link: `/suda-ui/employee/hrms/inbox`,
      },
      {
        label: t("HR_COMMON_CREATE_EMPLOYEE_HEADER"),
        link: `/suda-ui/employee/hrms/create`,
      },
    ],
  },
  FSM && {
    ...
    links: [
      {
        ...
        link: `/suda-ui/employee/mcollect/inbox`,
      },
      {
    ...
    links: [
      {
        ...
        link: `/suda-ui/employee/engagement/messages/inbox`,
      },
      {
        label: t("NEW_PUBLIC_MESSAGE_BUTTON_LABEL"),
        link: `/suda-ui/employee/engagement/messages/create`,
      },
    ],
  },
  {
    ...
    links: [
      {
        label: t("ES_TITLE_INBOX"),
        link: `/suda-ui/employee/engagement/surveys/inbox`,
      },
      {
        label: t("CS_COMMON_NEW_SURVEY"),
        link: `/suda-ui/employee/engagement/surveys/create`,
      },
    ],
  },
  {
    ...
    links: [
      {
        label: t("ES_TITLE_INBOX"),
        link: `/suda-ui/employee/engagement/event/inbox`,
      },
      {
        label: t("ES_TITLE_NEW_EVENTS"),
        link: `/suda-ui/employee/engagement/event/new-event`,
      },
    ],
  },
  {
    ...
    links: [
      {
        label: t("ES_TITLE_INBOX"),
        link: `/suda-ui/employee/engagement/documents/inbox`,
      },
      {
        label: t("NEW_DOCUMENT_TEXT"),
        link: `/suda-ui/employee/engagement/documents/new-doc`,
      },
    ],
  },
  RECEIPTS && {
    ...
    links: [
      {
        ...
        link: `/suda-ui/employee/receipts/inbox`,
      },
    ],
  },
  TL && {
  ...
  FSTPOperator && {
    ...
    links: [
      {
        label: t("ES_COMMON_INBOX"),
        link: "/suda-ui/employee/fsm/fstp-inbox",
      },
    ],
  },
  PGR && {
