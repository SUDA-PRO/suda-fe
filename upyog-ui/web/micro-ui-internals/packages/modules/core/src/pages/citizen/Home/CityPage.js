...
export default function CityPage({ citySlug: citySlugProp } = {}) {
  ...
  // City slug from prop (city-specific route like /suda-ui/ambikapur)
  const citySlug = citySlugProp || "";
  const loginUrl = citySlug
    ? `/suda-ui/login?userType=officer&city=${encodeURIComponent(citySlug)}&locked=true`
    : "/suda-ui/login";
