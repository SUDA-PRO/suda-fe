        ...
        
        {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={`/suda-ui/employee/ads/applicationsearch/application-details/${row.original["bookingNo"]}`}>
                ...
                const handleMakePayment = async () => {
                  try {
                    ...
                    if (isSlotBooked) {
                      ...
                      history.push({
                        pathname: `/suda-ui/employee/payment/collect/${"adv-services"}/${application?.bookingNo}`,
