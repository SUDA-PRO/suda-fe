...
*/
      ...
      const handleMakePayment = async () => {
        try {
          ...
          if (isSlotBooked) {
            ...
            history.push({
              pathname: `/suda-ui/citizen/payment/my-bills/${"adv-services"}/${application?.bookingNo}`,
  ...
  return (
    <Card>
      ...
      <div>
        <Link to={`/suda-ui/citizen/ads/application/${application?.bookingNo}/${application?.tenantId}`}>
