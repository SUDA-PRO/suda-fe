...
const PetApplication = ({ application, tenantId, buttonLabel }) => {
  ...
  const handleRenewalClick = () => {
    ...
    history.push(`/suda-ui/citizen/ptr/petservice/revised-application`);
  };
  ...
  return (
    <Card>
      ...
      <Link to={`/suda-ui/citizen/ptr/petservice/application/${application?.applicationNumber}/${application?.tenantId}`}>
