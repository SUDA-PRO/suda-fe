  ...
  const allLinks = [
    {
      ...
      link: "/suda-ui/employee/ptr/new-application",
      businessService: "ptr",
      roles: ["PT_CEMP"],
    },
    {
      text: "PTR_SEARCH_PET",
      link: `/suda-ui/employee/ptr/search`,
      businessService: "ptr",
      roles: [],
    },
    {
      text: "PTR_COMMON_APPLICATION_SEARCH",
      link: `/suda-ui/employee/ptr/application-search`,
      businessService: "ptr",
      roles: [],
    },
    // { text: "PT_REPORTS", hyperLink: true, link: "/suda-ui/employee/integration/dss/propertytax", roles: [], businessService: "PT" },
    // { text: "PT_DASHBOARD", link: "/suda-ui/employee/", roles: [], businessService: "PT" },
  ];
