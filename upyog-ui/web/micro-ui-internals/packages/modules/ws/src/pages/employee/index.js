...
const BILLSBreadCrumbs = ({ location }) => {
  ...
  let crumbs = [
    ...
    {
      path: "/suda-ui/employee/ws/water/search-application",
    ...
    {
      path: "/suda-ui/employee/ws/water/search-connection",
    ...
    {
      path: "/suda-ui/employee/ws/water/wns-search",
    ...
    {
      path: "/suda-ui/employee/ws/consumption-details",
    ...
    // {
    //   path: sessionStorage.getItem("redirectedfromEDIT") === "true"? (applicationNumbercheck?.includes("SW_AP")?  "/suda-ui/employee/ws/sewerage/search-application" : "/suda-ui/employee/ws/water/search-application") : "/suda-ui/employee/ws/application-details",
    ...
    {
      path: sessionStorage.getItem("redirectedfromEDIT") === "true"? (applicationNumbercheck?.includes("SW_AP")?  "/suda-ui/employee/ws/sewerage/search-application" : "/suda-ui/employee/ws/water/search-application") : "/suda-ui/employee/ws/modify-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/modify-details") ? true : false,
      isBack: sessionStorage.getItem("redirectedfromEDIT") !== "true" && fromScreen && true,
    },
    {
      path: "/suda-ui/employee/ws/disconnection-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/disconnection-details") ? true : false,
      isBack: fromScreen && true,
    },
    {
      path: "/suda-ui/employee/ws/connection-details",
    ...
    {
      path: "/suda-ui/employee/ws/edit-application",
    ...
    // {
    //   path: "/suda-ui/employee/sewerage/bill-amendment/inbox",
    //   content: t("ES_COMMON_BILLS_SEWERAGE_INBOX_LABEL"),
    //   show: location.pathname.includes("/sewerage/bill-amendment/inbox") ? true : false,
    // },
    {
