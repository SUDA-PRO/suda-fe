...
const VENDORCard = () => {
  ...
  const links=[
    ...
    //   label: t("Inbox"),
    //   link: `/suda-ui/employee/asset/assetservice/inbox`,
    // },
    
    {
      label: t("SEARCH_VENDOR"),
      link: `/suda-ui/employee/vendor/search-vendor?selectedTabs=VENDOR`
    },
    // {
    //   label: t("MY_ASSET_APPLICATION"),
    //   link: `/suda-ui/employee/asset/assetservice/my-asset`,
    // }
    // {
    //   label: t("AST_REPORT"),
    //   link: `/suda-ui/employee/asset/assetservice/report`,
    // }
