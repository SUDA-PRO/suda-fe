          ...
          <StatusTable>
            <React.Fragment>
              <Row
                ...
                actionButton={<ActionButton jumpTo={`/suda-ui/employee/vendor/registry/additionaldetails/vendor-details`} />}
              />
              <Row
              ...
              <Row
                ...
                actionButton={<ActionButton jumpTo={`/suda-ui/employee/vendor/registry/additionaldetails/vendor-detailss`} />}
              />
              <Row
              ...
              text={
                documents?.documents?.length > 0
                  ? documents.documents.map((doc, index) => (
                      <div key={index}>
                        <a
                          href={`/suda-ui/employee/vendor/registry/additionaldetails/documents/${doc.filestoreId}`}
                          target="_blank"
