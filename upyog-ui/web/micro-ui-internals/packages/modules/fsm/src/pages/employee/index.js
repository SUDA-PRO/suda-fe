...
export const FsmBreadCrumb = ({ location }) => {
  ...
  const crumbs = [
    {
      path: DSO ? "/suda-ui/citizen/fsm/dso-dashboard" : "/suda-ui/employee",
      content: t("ES_COMMON_HOME"),
      show: isFsm,
    },
    {
      path: isRegistry ? "/suda-ui/employee/fsm/registry?selectedTabs=VENDOR" : FSTPO ? "/suda-ui/employee/fsm/fstp-inbox" : "/suda-ui/employee",
      content: isVehicleLog ? t("ES_TITLE_INBOX") : "FSM",
      show: isFsm,
    },
    {
      path: isNewApplication ? "/suda-ui/employee/fsm/new-application" : "",
    ...
    {
      path: isInbox || isSearch || isApplicationDetails ? "/suda-ui/employee/fsm/inbox" : "",
      content: t("ES_TITLE_INBOX"),
      show: (isFsm && isInbox) || isSearch || isApplicationDetails,
    },
    {
      path: "/suda-ui/employee/fsm/search",
    ...
    {
      path: "/suda-ui/employee/fsm/registry/vendor-details/" + id,
      content: t("ES_TITLE_VENDOR_DETAILS"),
      show: isRegistry && (isVendorDetails || isVendorEdit),
    },
    {
      path: "/suda-ui/employee/fsm/registry/vehicle-details/" + id,
      content: t("ES_TITLE_VEHICLE_DETAILS"),
      show: isRegistry && (isVehicleDetails || isVehicleEdit),
    },
    {
      path: "/suda-ui/employee/fsm/registry/driver-details/" + id,
    ...
    {
      path: "suda-ui/employee/fsm/modify-application/" + id,
...
const EmployeeApp = ({ path, url, userType }) => {
  ...
  const moduleForSomeFSMAdmin = FSM_ADMIN
    ? [
        {
          link: "/suda-ui/employee/fsm/registry",
  ...
  const module = [
    ...
    {
      link: "/suda-ui/employee/fsm/inbox",
