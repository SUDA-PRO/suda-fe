...
const EditResponse = (props) => {
  ...
  return (
    <div>
      ...
      <ActionBar>
        <Link to={`${props.parentRoute.includes("employee") ? `/suda-ui/employee/asset/assetservice/applicationsearch/application-details/${mutation?.data?.Assets?.[0]?.applicationNo}` : false}`}>
