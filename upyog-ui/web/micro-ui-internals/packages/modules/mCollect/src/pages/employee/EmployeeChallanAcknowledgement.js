      ...
      {params?.applicationStatus === "CANCELLED" ? (
        <Card>
          ...
          <ActionBar style={{ display: "flex", justifyContent: "flex-end", alignItems: "baseline" }}>
            <Link to={`/suda-ui/employee`} style={{ marginRight: "1rem" }}>
        ...
        <Card>
          ...
          <ActionBar style={{ display: "flex", justifyContent: "flex-end", alignItems: "baseline" }}>
            ...
            <Link
              to={{
                pathname: `/suda-ui/employee/payment/collect/${params?.serviceCategory}/${params?.challanNumber}/tenantId=${params?.tenantId}?workflow=mcollect`,
              }}
            >
