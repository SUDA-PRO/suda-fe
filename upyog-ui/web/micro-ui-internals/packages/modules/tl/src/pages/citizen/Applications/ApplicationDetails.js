          ...
          return (
            <div key={index} className="employee-data-table">
              ...
              {PTData?.Properties && PTData?.Properties.length > 0 && (
                <div>
                  ...
                  <LinkButton
                    ...
                    onClick={() => {
                      history.push(
                        `/suda-ui/citizen/commonpt/view-property?propertyId=${PTData?.Properties?.[0]?.propertyId}&tenantId=${PTData?.Properties?.[0]?.tenantId}`
                      );
                    }}
                  ></LinkButton>
                </div>
              ...
              {application?.status === "CITIZENACTIONREQUIRED" ? (
                <Link
                  to={{
                    pathname: `/suda-ui/citizen/tl/tradelicence/edit-application/${application?.applicationNumber}/${application?.tenantId}`,
                    state: {},
                  }}
                >
