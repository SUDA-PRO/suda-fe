    ...
    <React.Fragment>
      ...
      { !(TradeDetails?.StructureType.code === "MOVABLE") && <Card>
        ...
        {/* <div style={{ textAlign: "left" }}>
          <Link to={`/suda-ui/citizen/commonpt/view-property?propertyId=${cpt?.details?.propertyId || cptId?.id || value?.tradeLicenseDetail?.additionalDetail?.propertyId}&tenantId=${cpt?.details?.tenantId || value?.tenantId}`}>
