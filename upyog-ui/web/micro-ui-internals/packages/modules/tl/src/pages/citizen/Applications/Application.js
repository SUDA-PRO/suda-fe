        ...
        return (
          <div>
            <Card>
              ...
              <Link to={`/suda-ui/citizen/tl/tradelicence/application/${application?.raw?.applicationNumber}/${application.raw?.tenantId}`}>
              ...
              {application?.raw?.status === "PENDINGPAYMENT" ? (
                  <Link
                  to={{
                    pathname : `/suda-ui/citizen/payment/collect/${data?.[0]?.raw?.businessService}/${application?.raw?.applicationNumber}`,
                  }}>
