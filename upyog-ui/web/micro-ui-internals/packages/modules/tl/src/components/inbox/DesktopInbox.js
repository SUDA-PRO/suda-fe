  ...
  const inboxColumns = () => [
    {
      ...
      Cell: ({ row }) => {
        return (
          <div>
            <span className="link">
            <Link to={"/suda-ui/employee/tl/application-details/" + row.original["applicationId"]}>{row.original["applicationId"]}</Link>
            </span>
          </div>
        );
      }
            ...
            allLinks={[
              {
                ...
                link: "/suda-ui/employee/tl/new-application",
                businessService: "TL",
                roles: ["TL_CEMP"],
              },
              {
                text: "TL_SEARCH_APPLICATIONS",
                link: "/suda-ui/employee/tl/search/application",
                businessService: "TL",
                roles: ["TL_FIELD_INSPECTOR","TL_APPROVER", "TL_DOC_VERIFIER","TL_CEMP"],
              },
              {
                text: "TL_SEARCH_LICENSE",
                link: "/suda-ui/employee/tl/search/license",
                businessService: "TL",
              ...
              },
              {
                ...
                link: "/suda-ui/employee/dss/dashboard/tradelicence",
                businessService: "TL",
                roles: ["STADMIN"],
              },
            ]}
