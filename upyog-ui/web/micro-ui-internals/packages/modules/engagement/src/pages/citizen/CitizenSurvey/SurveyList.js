...
const SurveyList = () => {
  ...
  //     history.push("/suda-ui/citizen/engagement/surveys/fill-survey", details);
  // };
  ...
  const handleCardClick = (details) => {
    ...
    if (!details.hasResponded) {
      history.push(`/suda-ui/citizen/engagement/surveys/fill-survey?applicationNumber=${details?.code}&tenantId=${details?.tenantId}`, details);
    } else {
      history.push("/suda-ui/citizen/engagement/surveys/show-survey", details);
    }
  };
