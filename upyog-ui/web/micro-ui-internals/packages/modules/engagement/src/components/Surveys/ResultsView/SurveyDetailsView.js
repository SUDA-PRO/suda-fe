  ...
  return (
      <div className="surveydetailsform-wrapper">
        ...
        {/* <button
          ...
          onClick={() => history.push(`/suda-ui/employee/engagement/surveys/inbox/details/${surveyId}`)}
        >
          <header style={{ color:"#a82227"}}>{t("SURVEY_QUESTIONS")}</header>
        </button> */}
        <LinkLabel  onClick={() => history.push(`/suda-ui/employee/engagement/surveys/inbox/details/${surveyTitle}`)}>
