...
const StreetVendingApplication = ({ application, buttonLabel,previousDraftId,onDiscard }) => {
  ...
  const handleEditClick = () => {
    ...
    history.push(`/suda-ui/citizen/sv/edit`);
  };
  ...
  return (
    <Card>
      ...
      <div style={{ display: "flex", gap: "5px" }}>
        <Link to={isDraft ? `/suda-ui/citizen/sv/apply/info` : `/suda-ui/citizen/sv/application/${application?.applicationNo}/${application?.tenantId}`}>
