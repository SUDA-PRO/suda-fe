    ...
    links: [
      {
        ...
        link: window.location.href.includes("/citizen") ? "/suda-ui/citizen/obps/search/application" : "/suda-ui/employee/obps/search/application",
        businessService: "BPA",
    ...
    <>
      ...
      {Digit.Utils.browser.isMobile() &&
        <div style={{marginLeft: "12px"}}>
          <Link to={window.location.href.includes("/citizen") ? "/suda-ui/citizen/obps/search/application" : "/suda-ui/employee/obps/search/application"}>
