...
const useInboxMobileCardsData = ({parentRoute, table, getRedirectionLink}) => {
    ...
    return ({ data:dataForMobileInboxCards,isTwoDynamicPrefix:true, linkPrefix: window.location.href.includes("/citizen") ?  `/suda-ui/citizen/obps/` : `/suda-ui/employee/obps/`,getRedirectionLink:getRedirectionLink, serviceRequestIdKey: "applicationNo", MobileSortFormValues})
