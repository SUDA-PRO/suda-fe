          ...
          
          {
              ...
              Cell: ({ row }) => {
                return (
                  <div>
                    <span className="link">
                      <Link to={`/suda-ui/employee/chb/applicationsearch/application-details/${row.original["bookingNo"]}`}>
              ...
              Cell: ({ row }) => {
                ...
                const handleMakePayment = async () => {
                  ...
                  if (isSlotBooked) {
                    ...
                    history.push({
                      pathname: `/suda-ui/employee/payment/collect/${"chb-services"}/${application?.bookingNo}`,
