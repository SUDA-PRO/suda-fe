  ...
  */
  ...
  const handleMakePayment = async () => {
    ...
    if (isSlotBooked) {
      ...
      history.push({
        pathname: `/suda-ui/citizen/payment/my-bills/${"chb-services"}/${application?.bookingNo}`,
  ...
  return (
    <Card>
      ...
      <div>
        <Link to={`/suda-ui/citizen/chb/application/${application?.bookingNo}/${application?.tenantId}`}>
