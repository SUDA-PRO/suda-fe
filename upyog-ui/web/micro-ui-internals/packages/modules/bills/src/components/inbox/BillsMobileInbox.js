        ...
        return (
          <div>
            <span className="link">
              <Link
                to={{
                  pathname: `/suda-ui/citizen/payment/collect/${original?.["businessService"]}/${original?.["consumerCode"]}/tenantId=${original?.["tenantId"]}?workflow=mcollect`,
                }}
              >
                {t(`${"ABG_COLLECT"}`)}
              </Link>
        ...
        return (
          <div>
            <span className="link">
              <Link
                to={{
                  pathname: `/suda-ui/employee/payment/collect/${original?.["businessService"]}/${original?.["consumerCode"]}/tenantId=${original?.["tenantId"]}?workflow=mcollect`,
                }}
              >
