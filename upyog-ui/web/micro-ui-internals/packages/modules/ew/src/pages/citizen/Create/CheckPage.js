        ...
        <div>
          ...
          <div style={{ border: "2px solid #ccc", borderRadius: "8px", padding: "20px", margin: "20px 0" }}>
            ...
            <StatusTable style={{ marginLeft: "20px" }}>
              <Row
                ...
                actionButton={<ActionButton jumpTo={`${`/suda-ui/citizen/ew/raiseRequest/productdetails`}`} />}
              />
            </StatusTable>
          </div>
          ...
          <StatusTable>
            <Row
              ...
              actionButton={<ActionButton jumpTo={`${`/suda-ui/citizen/ew/raiseRequest/owner-details`}`} />}
            />
            <Row
          ...
          <StatusTable>
            <Row
              ...
              actionButton={<ActionButton jumpTo={`${`/suda-ui/citizen/ew/raiseRequest/pincode`}`} />}
            />
            <Row
              label={t("EWASTE_SEARCH_CITY")}
              text={`${t(checkForNA(address?.city?.name))}`}
              actionButton={<ActionButton jumpTo={`${`/suda-ui/citizen/ew/raiseRequest/address`}`} />}
            />
            <Row
              label={t("EWASTE_SEARCH_STREET_NAME")}
              text={`${t(checkForNA(address?.street))}`}
              actionButton={<ActionButton jumpTo={`${`/suda-ui/citizen/ew/raiseRequest/street`}`} />}
            />
            <Row
