  ...
  return (
    <React.Fragment>
      <div>
        ...
        <LabelFieldPair>
            <CardLabel className={isMobile?"card-label-APK":"card-label-smaller"}>{t("UC_CONS_NAME_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <div className="field">
              <Controller
                control={control}
                name={"ConsumerName"}
          ...
          <LabelFieldPair>
            <CardLabel style={{paddingTop:"10px"}} className="card-label-smaller">{t("UC_MOBILE_NUMBER")} <span style={{ color: "red" }}>*</span></CardLabel>
            <div className="field">
              <Controller
                control={control}
                name={"mobileNumber"}
