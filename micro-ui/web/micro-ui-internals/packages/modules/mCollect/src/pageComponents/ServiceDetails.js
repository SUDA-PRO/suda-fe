...
const OwnerForm1 = (_props) => {
  ...
  return (
    <div  style={isMobile?{}:{marginTop:"-50px"}}>
      ...
      <LabelFieldPair>
            <CardLabel className="card-label-smaller">{t("UC_CITY_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <Controller
              name="city"
        ...
        <LabelFieldPair>
            <CardLabel className={isMobile?"card-label-APK":"card-label-smaller"}>{t("UC_SERVICE_CATEGORY_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <Controller
              name="category"
              rules={{ required: t("REQUIRED_FIELD") }}
          ...
          <LabelFieldPair>
            <CardLabel className="card-label-smaller">{t("UC_SERVICE_TYPE_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <Controller
              name="categoryType"
              rules={{ required: t("REQUIRED_FIELD") }}
          ...
          <LabelFieldPair>
            <CardLabel className="card-label-smaller">{t("UC_FROM_DATE_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <div className="field">
              <Controller
                name="fromDate"
                rules={{ required: t("REQUIRED_FIELD") }}
          ...
          <LabelFieldPair>
            <CardLabel className="card-label-smaller">{t("UC_TO_DATE_LABEL")} <span style={{ color: "red" }}>*</span></CardLabel>
            <div className="field">
              <Controller
                name="toDate"
                rules={{ required: t("REQUIRED_FIELD") }}
          ...
          <div>
          <LabelFieldPair>
            <CardLabel className={isMobile?"card-label-APK":"card-label-smaller"}>{t(stringReplaceAll(tax?.name,".","_"))} <span style={{ color: "red" }}>*</span></CardLabel>
            <div className="field">
              <Controller
                control={control}
                name={tax?.code}
